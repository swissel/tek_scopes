...
from tek_scopes.tex_osco import *
from datetime import datetime
import os
import csv

########################################
# Usage: beacon_scope.py
#
#	python beacon_scope.py [num_chans, num_events, prefix]
#
...
def beacon_scope(num_chan=1, num_events=5, prefix='tekScope', dircPrefix="/home/radio/data/tekScope/"):
...
if __name__ == "__main__":
    ...
    if(len(sys.argv) > 4):
        dircPrefix = sys.argv[4]

    # TAKE SOME DATA
    beacon_scope(num_chan=num_chan, num_events=num_events,
                 prefix=prefix, dircPrefix=dircPrefix)
